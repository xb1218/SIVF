...
class BaseInfo extends Component {
  ...
  //获取一个人的基本信息
  getPersonInfo = (sex) => {
    let { select_female, select_male } = this.props.store
    let params = sex ? select_female : select_male
    this.initInfo(params)
  }
  initInfo = (params) => {
  ...
  updatePatient = () => {
    ...
    if (this.patient1 === null) {
      let obj = {
        ...
        visitRoom: parseInt(localStorage.getItem("visitRoom")),
      }
  ...
  render() {
    ...
    const { infoState, sex } = this.props
    let {
      addSpouseVisble,
      isSearch,
      isEmpty,
        ...
        {!addSpouseVisble ? (
          ...
          >
            ...
            <Button
              type="primary"
              onClick={() => {
                this.setState({ isAddSpouse: true })
                this.props.close()
              }}
            >
              新增配偶
            ...
            <AddPatient
              ...
              onCancel={() => {
                this.props.close()
                this.setState({ isAddSpouse: false, addSpouseVisble: false })
              }}
